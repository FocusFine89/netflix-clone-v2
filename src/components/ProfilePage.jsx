        ...
        <Container className="text-light main">
            ...
            <Row className="edit-profile-container d-flex">
                ...
                <div className="maturity-settings">
                    ...
                    <Button type="button" className="btn btn-secondary my-3">ALL MATURITY RATINGS</Button>
                    <p>Show titles of all maturity ratings for this profile</p>
                    <Button type="button" className="btn btn-outline-secondary btn-lg px-5 py-2" disabled>Edit</Button>
                    <hr />
                    <div className="autoplay">
                        ...
                        <div className="check-group">
                            <label className="checkbox">
                                ...
                                Autoplay next episode in a series on all devices. <span></span>
                            </label>
                            <label className="checkbox">
                ...
                <Row className="btn-contanier">
                    <Col sm={3}>
                        <Button type="button" className="btn btn-outline-light btn-save">Save</Button>
                    </Col>
                    <Col sm={3}>
                    <Button type="button" className="btn btn-outline-light btn-cancel bg-secondary">Cancel</Button>
                    </Col>
                    <Col sm={6}>
                    <Button type="button" className="btn btn-outline-light btn-delete bg-danger">Delete</Button>
                    </Col>
                </Row>
